...
Der Fragebogen mit Fragen und Antwortmöglichkeiten ist [hier](https://cargorocket.github.io/survey/docs/questionaire.html) zu sehen und kann [hier](https://github.com/CargoRocket/survey/blob/main/codebuch.xlsx) auch als Excel, bzw [hier](https://github.com/CargoRocket/survey/blob/main/codebuch.csv) als csv heruntergeladen werden.

[Hier kann das Script dieser Auswertung](https://github.com/CargoRocket/survey/R/evaluation.Rmd) nachvollzogen werden.
